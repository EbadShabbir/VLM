...
IMAGE_DIR = '/kaggle/input/clever-dset/clever/CLEVR_v1.0/CLEVR_v1.0/images/val'
ANNOTATION_FILE = '/kaggle/input/clever-dset/clever/CLEVR_v1.0/CLEVR_v1.0/questions/CLEVR_val_questions.json'
...
def extract_features(image_path):
    try:
        ...
        with torch.no_grad():
            ...
            features = outputs.cpu().numpy().squeeze()
...
np.save(os.path.join(OUTPUT_PATH, "clip_val_features.npy"), train_features_array)
np.save(os.path.join(OUTPUT_PATH, "clip_val_labels.npy"), train_labels_array)
